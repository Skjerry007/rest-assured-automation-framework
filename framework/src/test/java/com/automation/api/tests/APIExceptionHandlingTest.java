...
import com.automation.api.exceptions.APIException;
...
public class APIExceptionHandlingTest {
    ...
    public void testConnectionTimeout() {
        ...
        try {
            ...
            // Verify that the exception is either ConnectException, SocketTimeoutException, or NullPointerException
            Throwable cause = e.getCause();
            boolean found = false;
            while (cause != null) {
                if (cause instanceof ConnectException || cause instanceof SocketTimeoutException || cause instanceof NullPointerException) {
            ...
            if (!found && (e instanceof NullPointerException)) {
                LoggerUtil.info("Caught NullPointerException as expected");
                return;
            }
            if (!found) {
                Assert.fail("Expected ConnectException, SocketTimeoutException, or NullPointerException, but got: " + e.getClass().getName());
            }
        }
    }
