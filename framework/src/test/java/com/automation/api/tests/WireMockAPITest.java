...
import com.automation.api.constants.StatusCodes;
import com.automation.api.models.User;
import com.automation.common.utils.LoggerUtil;
import com.automation.api.utils.ResponseValidator;
...
public class WireMockAPITest {
    ...
    public void setup() {
        ...
        com.automation.common.config.ConfigManager.getInstance().setProperty("baseUrl", "http://" + HOST + ":" + PORT);
